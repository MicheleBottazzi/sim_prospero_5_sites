...
df = pd.read_csv('/home/drugo/simProspero/data/DE_Rur/DE_Rur_ElCorr_pos.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=2)
df1 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur/prospero_DE_Rur_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df2 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur/prospero_DE_Rur.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df3 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur_latentHeat_FAO_valid_2.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df4 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur_latentHeat_FAO.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df5 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur_latentHeat_PT_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df6 = pd.read_csv('/home/drugo/simProspero/output/DE_Rur_latentHeat_PT.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
...
df.columns = ['obs','ps_cal','ps_not_cal','fao_cal','fao_not_cal','pt_cal','pt_not_cal']
print(df.head())
...
print('RMSE pt not cal:     ',((dfDay.pt_not_cal - dfDay.obs) ** 2).mean() ** .5)

print('#######################')

print('MAE fao cal:         ',dfDay.eval('fao_cal-obs').abs().mean())
print('MAE fao not cal:     ',dfDay.eval('fao_not_cal-obs').abs().mean())
print('MAE ps cal:          ',dfDay.eval('ps_cal-obs').abs().mean())
print('MAE ps not cal:      ',dfDay.eval('ps_not_cal-obs').abs().mean())
print('MAE pt cal:          ',dfDay.eval('pt_cal-obs').abs().mean())
print('MAE pt not cal:      ',dfDay.eval('pt_not_cal-obs').abs().mean())

print('#######################')

print('R^{2} fao cal:       ',dfDay.fao_cal.corr(dfDay.obs))
print('R^{2} fao not cal:   ',dfDay.fao_not_cal.corr(dfDay.obs))
print('R^{2} ps cal:        ',dfDay.ps_cal.corr(dfDay.obs))
print('R^{2} ps not cal:    ',dfDay.ps_not_cal.corr(dfDay.obs))
print('R^{2} pt cal:        ',dfDay.pt_cal.corr(dfDay.obs))
print('R^{2} pt not cal:    ',dfDay.pt_not_cal.corr(dfDay.obs))

print('#######################')

print('index d fao cal:     ',gof.d(np.array(dfDay.fao_cal),np.array(dfDay.obs)))
print('index d fao not cal: ',gof.d(np.array(dfDay.fao_not_cal),np.array(dfDay.obs)))
print('index d ps cal:      ',gof.d(np.array(dfDay.ps_cal),np.array(dfDay.obs)))
print('index d ps not cal:  ',gof.d(np.array(dfDay.ps_not_cal),np.array(dfDay.obs)))
print('index d pt cal:      ',gof.d(np.array(dfDay.pt_cal),np.array(dfDay.obs)))
print('index d pt not cal:  ',gof.d(np.array(dfDay.pt_not_cal),np.array(dfDay.obs)))

print('#######################')

print('nse fao cal:     ',gof.nse(np.array(dfDay.fao_cal),np.array(dfDay.obs)))
print('nse fao not cal: ',gof.nse(np.array(dfDay.fao_not_cal),np.array(dfDay.obs)))
print('nse ps cal:      ',gof.nse(np.array(dfDay.ps_cal),np.array(dfDay.obs)))
print('nse ps not cal:  ',gof.nse(np.array(dfDay.ps_not_cal),np.array(dfDay.obs)))
print('nse pt cal:      ',gof.nse(np.array(dfDay.pt_cal),np.array(dfDay.obs)))
print('nse pt not cal:  ',gof.nse(np.array(dfDay.pt_not_cal),np.array(dfDay.obs)))

print('#######################')

print('kge fao cal:     ',gof.kge(np.array(dfDay.fao_cal),np.array(dfDay.obs)))
print('kge fao not cal: ',gof.kge(np.array(dfDay.fao_not_cal),np.array(dfDay.obs)))
print('kge ps cal:      ',gof.kge(np.array(dfDay.ps_cal),np.array(dfDay.obs)))
print('kge ps not cal:  ',gof.kge(np.array(dfDay.ps_not_cal),np.array(dfDay.obs)))
print('kge pt cal:      ',gof.kge(np.array(dfDay.pt_cal),np.array(dfDay.obs)))
print('kge pt not cal:  ',gof.kge(np.array(dfDay.pt_not_cal),np.array(dfDay.obs)))

print('#######################')

dfMonth = dfDay[['obs','ps_cal','ps_not_cal','fao_cal','fao_not_cal','pt_cal','pt_not_cal']].copy()
dfYear = dfDay[['obs','ps_cal','ps_not_cal','fao_cal','fao_not_cal','pt_cal','pt_not_cal']].copy()
...
dfPrpY = pd.read_csv('/home/drugo/simProspero/data/DE_Rur/DE_Rur_Prp_Year.csv', index_col='TIMESTAMP')
...
dfMonth.plot(y=['obs','ps_cal','ps_not_cal','fao_cal','fao_not_cal',
                'pt_cal','pt_not_cal'],kind='line', ax = ax1, 
...
dfYear.plot(y=['obs','ps_cal','ps_not_cal','fao_cal','fao_not_cal',
               'pt_cal','pt_not_cal','prp'],x='year',kind='bar', ax = ax2, 
...
fig2.savefig('histogram_DE_Rur.png')
...
sns.kdeplot(data=dfDay, ax=axes[2],x=dfDay.ps_not_cal, hue="SEASON")
sns.kdeplot(data=dfDay, ax=axes[3],x=dfDay.fao_cal, hue="SEASON")
sns.kdeplot(data=dfDay, ax=axes[4],x=dfDay.fao_not_cal, hue="SEASON")
sns.kdeplot(data=dfDay, ax=axes[5],x=dfDay.pt_cal, hue="SEASON")
sns.kdeplot(data=dfDay, ax=axes[6],x=dfDay.pt_not_cal, hue="SEASON")
...
fig.savefig('distribution_DE_Rur.png')
