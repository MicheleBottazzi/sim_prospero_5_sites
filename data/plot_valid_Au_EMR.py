...
df1 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr/prospero_AU_Emr_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df2 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr/prospero_AU_Emr.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df3 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr_latentHeat_FAO_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df4 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr_latentHeat_FAO.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df5 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr_latentHeat_PT_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df6 = pd.read_csv('/home/drugo/simProspero/output/AU_Emr_latentHeat_PT.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
