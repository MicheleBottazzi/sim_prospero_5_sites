...
df = pd.read_csv('/home/drugo/simProspero/data/US_Var/US_Var_ElCorr_pos.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=2)
df1 = pd.read_csv('/home/drugo/simProspero/output/US_Var/prospero_US_Var_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df2 = pd.read_csv('/home/drugo/simProspero/output/US_Var/prospero_US_Var.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df3 = pd.read_csv('/home/drugo/simProspero/output/US_Var_latentHeat_FAO_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df4 = pd.read_csv('/home/drugo/simProspero/output/US_Var_latentHeat_FAO.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)

df5 = pd.read_csv('/home/drugo/simProspero/output/US_Var_latentHeat_PT_valid.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
df6 = pd.read_csv('/home/drugo/simProspero/output/US_Var_latentHeat_PT.csv', na_values=-9999, parse_dates=[1], index_col=[1], skiprows=6)
...
dfPrpY = pd.read_csv('/home/drugo/simProspero/data/US_Var/US_Var_Prp_Year.csv', index_col='TIMESTAMP')
...
fig2.savefig('histogram_US_Var.png')
...
fig.savefig('distribution_US_Var.png')
